        ...
        if (playerInfo.data.leaderboardStats.length === 3) {
          const playerData = {
            ...
            rm1v1Stats: {
              ...
              highestrating: playerInfo.data.leaderboardStats[0].highestrating,
            },
            rmTGStats: {
              ...
              highestrating: playerInfo.data.leaderboardStats[1].highestrating,
            },
            rmEWStats: {
              ...
              highestrating: playerInfo.data.leaderboardStats[2].highestrating,
            },
          };
          resolve(playerData);
        }
